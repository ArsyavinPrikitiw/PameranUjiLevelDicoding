...
const PROJECTS = [
...

  {
    ...
    tema     : 'FinTech',
    cat      : '6',
    deskripsi: 'Web kita bernama FinEdu - Web Literasi Finansial Digital yang terdapat module pembelajaran berupa materi dan video, Dashboard, Calculator, Profile, dan Simulasi Kelola Keuangan, serta fitur login dan registrasi.',    
    stack    : ['HTML', 'CSS', 'JSX', 'PHP'],
